...
public class MobileBrowserGenericUtils {
    ...
    public void appiumConfiguration() throws URISyntaxException, MalformedURLException {
        ...
        options.setChromedriverExecutable("D:/Core Java/projects/AppiumMobileAutomation/src/main/resources/ChromeDriver/chromedriver.exe");// This version should be compatible with the version which you have in your testing device
        // Setting the browser name to Chrome
